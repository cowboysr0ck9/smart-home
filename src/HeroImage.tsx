...
function HeroImage() {
    ...
    return (
        <div id="homeMap">
            <ul>
                <li id="tvDeviceZoneCard">
                    <ProductCard
                        isOpen={card['tvDeviceZone']}
                        ...
                        productMetaLink="/"
                        onClose={() => toggle('tvDeviceZone')}
                        copy="Smart TVs are connected and Internet-ready. Most
                                TVs available on the market now have smart
                                capabilities, allowing customers to enjoy a
                                wider range of entertainment: stream movies,
                                shows and music from dozens of channels, browse
                                the web or connect with other entertainment
                                devices."
                        productMetaLinkText="View Product"
                        productMetaName="SONY 65 LED 4K ULTRA HD SMART TV"
                        shopMoreBtn="SHOP ALL HOME HUBS"
                        shopMoreBtnLink="/"
                        title="Home hubs and voice assistants"
                        key=""
                    ></ProductCard>
                </li>
